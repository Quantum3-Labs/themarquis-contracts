    ...
    OwnableUpgradeable
{
    ...
    modifier onlyVault() {
        require(
            msg.sender == VaultAddr,
            "MarquisMsgAdapter: Only Vault contract can call this function"
        );
        _;
    }
    ...
    function transmitDeposit(
        uint256 _amount,
        address _l2Receipient
        ...
        payload[2] = uint256(uint160(_l2Receipient)); // this is always a felt
