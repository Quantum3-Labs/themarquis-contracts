...
use l2_v1_0::the_marquis::models::{Choice};
...
mod actions {
    ...
    use l2_v1_0::the_marquis::models::{Game, Choice, Move, WorldHelperStorage};
    use l2_v1_0::the_marquis::utils::{seed, random, is_winning_move,get_multiplier, make_move, MAX_AMOUNT_MOVES};
    use super::IActions;
